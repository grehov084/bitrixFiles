...
?><div class="bx-middle-nav bx-<?=$arParams["MENU_THEME"]?>" id="<?=$menuBlockId?>">
	<div class="bx-middle-nav-wrap">
	<nav class="bx-middle-nav-container" id="cont_<?=$menuBlockId?>">
		<ul class="bx-nav-list-1-lvl bx-middle-list" id="ul_<?=$menuBlockId?>">
						...
						<?foreach($arRow as $itemIdLevel_2=>$arLevel_3):?>  <!-- second level-->
							<?
								if($counter % 6 == 0 && $counter > 0){
									echo'</ul><ul class="bx-nav-list-2-lvl">';
								}
								$counter++;
							?>
